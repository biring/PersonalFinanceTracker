...
public class MenuHelper {
    ...
    public <T extends Enum<T> & MenuInterface> T getEnumMenuSelection(Class<T> enumType, String title, String message) {
    ...
    private <T extends Enum<T> & MenuInterface> String[] getMenuOptions(Class<T> enumType) {
    ...
    private <T extends Enum<T> & MenuInterface> T getUserSelection(String[] menuOptions, String message, Class<T> enumType) {

...
class TransactionViewTest {
    ...
    public void testDisplayMenu() {
        ...
        TransactionView transactionView = new TransactionView(mockScanner) {
        ...
        // Act
        transactionView.displayMenu(menuOptions);
    ...
    public void testPromptForMenuSelection_ValidInput() {
        ...
        // Act
        int selection = transactionView.promptForMenuSelection(message);

...
class BudgetViewTest {
    ...
    public void testDisplayMenu() {
        ...
        BudgetView budgetView = new BudgetView(mockScanner) {
        ...
        // Act
        budgetView.displayMenu(menuOptions);
    ...
    public void testPromptForMenuSelection_ValidInput() {
        ...
        // Act
        int selection = budgetView.promptForMenuSelection(message);
